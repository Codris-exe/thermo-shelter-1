...
const Shelter3D = dynamic(() => import("@/components/Shelter3D"), {
  ssr: false,
  loading: () => (
    <div className="flex h-full w-full items-center justify-center font-mono text-xs text-amber-400">
      <span className="w-2 h-2 rounded-full bg-amber-400 status-ping mr-2" />
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#070b14] text-slate-100 selection:bg-amber-500 selection:text-slate-950 antialiased font-sans">
      ...
      <div className="border-b border-white/[0.08] bg-[#050810] px-6 lg:px-12 py-2 text-[11px] font-mono tracking-wider text-slate-400 flex justify-between items-center relative z-20">
      ...
      <header className="sticky top-0 z-50 bg-[#070b14]/85 backdrop-blur-md border-b border-white/[0.08]">
        <div className="flex justify-between items-center max-w-7xl mx-auto px-6 lg:px-12 h-16">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              <div
                className="text-sm font-bold tracking-tight text-white group-hover:text-amber-400 transition-colors"
      ...
      <main>
        ...
        <section
          id="hero-3d"
          className="relative min-h-[calc(100vh-80px)] flex flex-col justify-center py-16 lg:py-24 border-b border-white/[0.08] overflow-hidden"
        >
          ...
          <div className="absolute inset-0 z-0">
            <Image
              ...
              fill
              priority
              className="object-cover object-center opacity-30 filter contrast-110 brightness-95"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#070b14] via-[#070b14]/80 to-[#070b14]/65" />
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                <h1
                  ...
                  style={{ fontFamily: "var(--font-headline)" }}
                >
                  Engineered for <span className="text-cyan-400">-50°C</span>.
                  <br />
                ...
                <p className="text-slate-300 text-base sm:text-lg font-normal leading-relaxed max-w-xl">
                  ...
                  <strong className="text-amber-400 font-semibold">+19.5°C</strong> interior through
                ...
                <div className="flex flex-wrap items-center gap-4 pt-2">
                  ...
                  <a
                    href="#how-it-works"
                    className="chamfer-btn border border-white/20 bg-[#090e1b]/80 hover:bg-slate-800 text-slate-200 font-mono text-xs px-6 py-4 tracking-wider uppercase transition-colors backdrop-blur-sm"
                  >
                    Heat Flow Diagram ↓
                  </a>
                </div>
                ...
                {/* Quick HUD Metrics */}
                <div className="grid grid-cols-3 gap-3 pt-4 border-t border-white/10 font-mono text-[11px]">
                  <div className="border border-white/10 bg-[#060913]/80 p-2.5 rounded-lg backdrop-blur-sm">
                    <div className="text-slate-400 uppercase text-[9px]">Internal Core</div>
                    <div className="text-base font-bold text-amber-400 mt-0.5">+19.5°C</div>
                    <div className="text-slate-500 text-[9px]">Autonomous</div>
                  </div>

                  <div className="border border-white/10 bg-[#060913]/80 p-2.5 rounded-lg backdrop-blur-sm">
                    <div className="text-slate-400 uppercase text-[9px]">Insulation Barrier</div>
                    <div className="text-base font-bold text-cyan-400 mt-0.5">R-82.4</div>
                    <div className="text-slate-500 text-[9px]">Aerogel Core</div>
                  </div>

                  <div className="border border-white/10 bg-[#060913]/80 p-2.5 rounded-lg backdrop-blur-sm">
                    <div className="text-slate-400 uppercase text-[9px]">Aux Fuel</div>
                    <div className="text-base font-bold text-emerald-400 mt-0.5">0.0 L</div>
              ...
              <div className="lg:col-span-6">
                <div className="border border-white/20 bg-[#090e1b]/90 backdrop-blur-md rounded-2xl overflow-hidden corner-bracket shadow-2xl">
                  {/* 3D Viewport Header */}
                  <div className="flex items-center justify-between border-b border-white/10 bg-[#060913]/90 px-4 py-3 font-mono text-xs">
                    ...
                    <div className="text-[10px] text-slate-400">
                      ORBIT: <span className="text-cyan-400 font-bold">DRAG 360°</span>
                    </div>
                  </div>

                  {/* 3D WebGL Canvas */}
                  <div className="relative h-[340px] sm:h-[380px] w-full cad-grid-dense bg-[#050810]">
                    {/* Live CAD Floating Telemetry */}
                    <div className="absolute left-3 top-3 z-10 font-mono text-[10px] space-y-1 bg-[#060913]/80 border border-white/10 p-2 rounded backdrop-blur-sm pointer-events-none">
                      ...
                      <div className="text-slate-400">
                        AZIMUTH: <span className="text-amber-400 font-bold">{orientation}°</span>
                      </div>
                      <div className="text-slate-400">
                        SOLAR EFFICIENCY:{" "}
                        <span className="text-emerald-400 font-bold">{solarCaptureEff}%</span>
                      </div>
                    </div>
                  ...
                  <div className="p-4 border-t border-white/10 bg-[#070c17] space-y-3 font-mono text-xs">
                    {/* Presets */}
                    ...
                    <div className="space-y-1">
                      <div className="flex justify-between items-center text-[10px]">
                        <span className="text-slate-400 uppercase">Orientation Azimuth:</span>
                      ...
                      <div className="flex justify-between text-[9px] text-slate-500 pt-0.5">
                        <span>N (0°)</span>
                        <span>E (90°)</span>
                        <span className="text-amber-400 font-bold">S (180° Optimal)</span>
                        <span>W (270°)</span>
                        <span>N (360°)</span>
                      </div>
                    </div>
                    ...
                    <div className="pt-1">
                      <Link
                        href="/3d"
                        className="chamfer-btn w-full bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold py-2.5 text-center text-xs uppercase tracking-wider transition-colors flex items-center justify-center gap-2"
                      >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-16 pt-8 border-t border-white/[0.08] font-mono">
              <div className="p-5 border border-white/[0.08] bg-[#0b1120]/80 rounded-xl backdrop-blur-sm">
            ...
            <div className="border border-white/10 bg-[#090e1b] rounded-2xl overflow-hidden p-6 sm:p-8">
              <div className="relative w-full aspect-[16/9] max-h-[460px] bg-[#050810] border border-white/5 rounded-xl p-4 flex items-center justify-center cad-grid-dense">
                ...
                >
                  ...
                  <text fill="#f59e0b" fontFamily="monospace" fontSize="9" x="420" y="240">
                    HEAT CORE
                  </text>
                  <text
                    fill="#e2e8f0"
                  ...
                  <text fill="#f59e0b" fontFamily="monospace" fontSize="8" x="320" y="140">
                  ...
                  <text fill="#38bdf8" fontFamily="monospace" fontSize="8" x="250" y="325">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 font-mono">
                ...
                <div className="p-4 border border-white/[0.08] bg-[#070b14] rounded-xl">
                  <div className="text-emerald-400 font-bold text-xs uppercase mb-1">
        ...
        <section
          id="night-autonomy"
          className="relative py-24 lg:py-32 border-b border-white/[0.08] overflow-hidden"
        >
          ...
          <div className="absolute inset-0 z-0">
            <Image
              ...
              fill
              className="object-cover object-center opacity-30 filter contrast-125 brightness-90"
            />
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-mono">
              <div className="border border-white/15 bg-[#090e1b]/85 backdrop-blur-md rounded-2xl p-6 corner-bracket">
                <div className="w-9 h-9 rounded-lg bg-amber-500/10 border border-amber-500/30 flex items-center justify-center text-amber-400 font-bold text-sm mb-4">
                  11.4h
                </div>
                ...
                <div className="mt-4 pt-4 border-t border-white/10 flex justify-between text-[11px]">
                  <span className="text-slate-500">Core Temp Drop:</span>
                  <span className="text-emerald-400 font-bold">&lt; 1.8°C / 12h</span>
                </div>
              </div>

              <div className="border border-white/15 bg-[#090e1b]/85 backdrop-blur-md rounded-2xl p-6 corner-bracket">
                <div className="w-9 h-9 rounded-lg bg-cyan-500/10 border border-cyan-500/30 flex items-center justify-center text-cyan-400 font-bold text-sm mb-4">
                  R-82
                </div>
                <h3 className="text-base font-bold text-white uppercase mb-2">
                ...
                <div className="mt-4 pt-4 border-t border-white/10 flex justify-between text-[11px]">
                  ...
                  <span className="text-cyan-400 font-bold">0.012 W/m²K</span>
                </div>
              </div>

              <div className="border border-white/15 bg-[#090e1b]/85 backdrop-blur-md rounded-2xl p-6 corner-bracket">
                <div className="w-9 h-9 rounded-lg bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center text-emerald-400 font-bold text-sm mb-4">
                  0.0L
                </div>
                <h3 className="text-base font-bold text-white uppercase mb-2">
                ...
                <div className="mt-4 pt-4 border-t border-white/10 flex justify-between text-[11px]">
                  ...
                  <span className="text-emerald-400 font-bold">1,800 L / winter</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="border-t border-white/[0.08] bg-[#050810] py-8 px-6 lg:px-12 text-slate-500 font-mono text-xs">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="#night-autonomy" className="hover:text-slate-300 transition-colors">
              Night Autonomy
            </a>
